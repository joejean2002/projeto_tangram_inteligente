...
void loop() {
  // Verificar se o botão V foi pressionado para iniciar ou parar o temporizador
  ...
  // Verificar se o botão A foi pressionado para iniciar ou parar o temporizador
